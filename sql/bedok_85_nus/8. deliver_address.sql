...
CREATE TABLE `deliver_address` (
  ...
  KEY `deliver_address_ibfk_1` (`order_id`),
  CONSTRAINT `deliver_address_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `order` (`order_id`) ON DELETE CASCADE ON UPDATE CASCADE
