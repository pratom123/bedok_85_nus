...
<body>
    ...
    <div class='path_directory'>
        <!-- path directory -->
    <a href='../../home/index.php'>Home</a>&nbsp;&rarr;&nbsp;Xing Ji Rou Cuo Mian&nbsp;&rarr;&nbsp;<a href=''>Bak Chor Mee (Large)</a>
    </div>
    <main>
        <div id='dish_wrapper'>
            ...
            <form action='../../common/process_cart.php' method='GET' id='add_update_item'>
                ...
                if(isset($_GET["purpose"]) && $_GET["purpose"] == "update_item") {
                    ...
                    <input type='hidden' name='item_dish_name' value='Bak Chor Mee (Large)'>
                ...
                <header>
                    ...
                    <aside>
                        ...
                        <div class='row_start_end'>
                            <span class='dish_name'>Bak Chor Mee (Large)</span>
                            <div class='dish_price'>
                            <span>$</span>
                            <span id='base_price'>4.00</span>
                            </div>
                        </div>
                    </aside>
                </header>
                    ...
                    <div id='price_submit_wrapper'>
                        <div>
                            ...
                            <input type='text' id='price_display' name='item_price' onfocus='blur()' value='<?php 
                                    echo (isset($i) && !empty($cart[$i]['item_price']))? $cart[$i]['item_price']: '4.00';?>'>
                        </div>
